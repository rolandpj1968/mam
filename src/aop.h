...
AO(iceq32,    T(i32t,i32t,i32t), S(2,1))
AO(icne32,    T(i32t,i32t,i32t), S(2,1))
AO(iceq64,    T(i32t,i32t,i32t), S(2,1))
AO(icne64,    T(i32t,i32t,i32t), S(2,1))

AO(icsge32,   T(i32t,i32t,i32t), S(2,1))
AO(icsgt32,   T(i32t,i32t,i32t), S(2,1))
AO(icsle32,   T(i32t,i32t,i32t), S(2,1))
AO(icslt32,   T(i32t,i32t,i32t), S(2,1))
AO(icuge32,   T(i32t,i32t,i32t), S(2,1))
AO(icugt32,   T(i32t,i32t,i32t), S(2,1))
AO(icule32,   T(i32t,i32t,i32t), S(2,1))
AO(icult32,   T(i32t,i32t,i32t), S(2,1))
...
AO(fceq32,    T(f32t,f32t,f32t), S(2,1))
AO(fcge32,    T(f32t,f32t,f32t), S(2,1))
AO(fcgt32,    T(f32t,f32t,f32t), S(2,1))
AO(fcle32,    T(f32t,f32t,f32t), S(2,1))
AO(fclt32,    T(f32t,f32t,f32t), S(2,1))
AO(fcne32,    T(f32t,f32t,f32t), S(2,1))
AO(fco32,     T(f32t,f32t,f32t), S(2,1))
AO(fcuo32,    T(f32t,f32t,f32t), S(2,1))

AO(fceq64,    T(f64t,f64t,f64t), S(2,1))
AO(fcge64,    T(f64t,f64t,f64t), S(2,1))
AO(fcgt64,    T(f64t,f64t,f64t), S(2,1))
AO(fcle64,    T(f64t,f64t,f64t), S(2,1))
AO(fclt64,    T(f64t,f64t,f64t), S(2,1))
AO(fcne64,    T(f64t,f64t,f64t), S(2,1))
AO(fco64,     T(f64t,f64t,f64t), S(2,1))
AO(fcuo64,    T(f64t,f64t,f64t), S(2,1))

/* Extensions and Truncations */

AO(i32exts8,  T(i32t,vxxt,i32t), S(1,1))
AO(i32extu8,  T(i32t,vxxt,i32t), S(1,1))
AO(i32exts16, T(i32t,vxxt,i32t), S(1,1))
AO(i32extu16, T(i32t,vxxt,i32t), S(1,1))

AO(i64exts8,  T(i64t,vxxt,i64t), S(1,1))
AO(i64extu8,  T(i64t,vxxt,i64t), S(1,1))
AO(i64exts16, T(i64t,vxxt,i64t), S(1,1))
AO(i64extu16, T(i64t,vxxt,i64t), S(1,1))

AO(i64exts32, T(i64t,vxxt,i64t), S(1,1))
AO(i64extu32, T(i64t,vxxt,i64t), S(1,1))

AO(fext32,    T(f32t,vxxt,f64t), S(1,1))
AO(ftrunc64,  T(f64t,vxxt,f32t), S(1,1))

/* Select using remote alu condition */
AO(sel0,      T(v64t,v64t,v64t), S(2,1))
AO(sel1,      T(v64t,v64t,v64t), S(2,1))
AO(sel2,      T(v64t,v64t,v64t), S(2,1))
AO(sel3,      T(v64t,v64t,v64t), S(2,1))

AO(f32tosi32, T(f32t,vxxt,i32t), S(1,1))
AO(f32toui32, T(f32t,vxxt,i32t), S(1,1))
AO(f32tosi64, T(f32t,vxxt,i64t), S(1,1))
AO(f32toui64, T(f32t,vxxt,i64t), S(1,1))
AO(f64tosi32, T(f64t,vxxt,i32t), S(1,1))
AO(f64toui32, T(f64t,vxxt,i32t), S(1,1))
AO(f64tosi64, T(f64t,vxxt,i64t), S(1,1))
AO(f64toui64, T(f64t,vxxt,i64t), S(1,1))

AO(i32stof32, T(i32t,vxxt,f32t), S(1,1))
AO(i32utof32, T(i32t,vxxt,f32t), S(1,1))
AO(i64stof32, T(i64t,vxxt,f32t), S(1,1))
AO(i64utof32, T(i64t,vxxt,f32t), S(1,1))
AO(i32stof64, T(i32t,vxxt,f64t), S(1,1))
AO(i32utof64, T(i32t,vxxt,f64t), S(1,1))
AO(i64stof64, T(i64t,vxxt,f64t), S(1,1))
AO(i64utof64, T(i64t,vxxt,f64t), S(1,1))
...
AO(tos0,      T(vxxt,vxxt,v64t), S(0,1))
AO(tos1,      T(vxxt,vxxt,v64t), S(0,1))
AO(tos2,      T(vxxt,vxxt,v64t), S(0,1))
AO(tos3,      T(vxxt,vxxt,v64t), S(0,1))
